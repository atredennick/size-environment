...
focalSpp<-paste0("h:/arizonachart/ipm/Age & Size2/speciesData/",focalSppName,"/",focalSppName,"_genet_xy.csv")
sppShapes <- c("h:/arizonachart/lifetables/polys/Species/Bouteloua eriopoda/",
               "h:/arizonachart/lifetables/polys/Species/Bouteloua rothrockii/",
               "h:/arizonachart/lifetables/polys/Species/Heteropogon contortus/",
                "h:/arizonachart/lifetables/polys/Species/Hilaria belangeri/")
nbSpp <- c("BOER","BORO","HECO","HIBE")  # make sure these are listed in same order as sppShapes
annuli <- c(seq(2,20,2),seq(25,50,5),seq(60,150,10))
outfile <- paste0("h:/arizonachart/ipm/Age & Size2/speciesData/",focalSppName,"/",focalSppName,"_nbhood_rings.csv")
